    ...
    [LogSelector_FetchProfilingData] =
        {
            ...
            .checkScalarOutputCount =   1, // number of probes returned
            .checkStructureOutputSize = kIOUCVariableStructureSize, // array of probes
        },
};
    ...
    IOExternalMethodArguments* arguments)
{
    ...
    return dj_profile_iouc_export(profile_probes, Probe_Count, arguments);
#else
